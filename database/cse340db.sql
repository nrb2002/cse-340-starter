-- ENUM field
/*
    ENUM field is a field where you pre-set the possible values that the field can hold. 
    When data is entered into the field, it will not allow any value if it does not exist in the list of possibilities. 
    Unfortunately, PostgreSQL does not support this field type. 
    Therefore, we must create it as a separate "type" definition in our database.
*/
...
/*
    ...
    Type account_type in the "Name" text box. Leave the other settings as they are.
    Screenshot of the pgAdmin Create Type dialog box
    Click "Definition" in the top bar.
    ...
    Type Client in the text box.
    Click the "+" to the right of "Enumeration type".
    Type Employee in the text box.
    Click the "+" to the right of "Enumeration type".
    Type Admin in the text box.
    Click "SQL" in the top bar. The image is only an example. Your code should match the values you typed.
