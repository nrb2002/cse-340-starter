...
//req.flash("notice", "This is a flash message.") //uses the "flash" package to assign the message to the request object. The first parameter indicates the "type" of message - it becomes a class in the browser - while the second one is the actual message.
